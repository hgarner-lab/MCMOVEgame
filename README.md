...
Open `index.html` in a modern desktop browser. No build step, server, external libraries, or game engines are required. The cabinet presentation uses local assets in `assets/`.

## GitHub Pages

Upload the contents of this folder to the root of a GitHub Pages repository. Keep these files together:

- `index.html`
- `styles.css`, `branding.css`, `cabinet.css`
- `game.js`, `cabinet-fit.js`
- `assets/cabinet-frame.png`
- `assets/mastercard-mark.png`
